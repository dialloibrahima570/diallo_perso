...
<title>Votre projet est prêt</title>
...
.box{background:#f0fdf4;border-left:4px solid #6b7280;padding:14px 18px;border-radius:5px;margin:18px 0}
.btn{display:inline-block;padding:12px 22px;background:#e7e7e7;color:#cd2e2e;border-radius:8px;text-decoration:none;font-weight:500}
...
<p>Votre projet est prêt. Vous pouvez le télécharger en cliquant sur le bouton ci-dessous :</p>

<p>
<a href="{{ $link }}" class="btn">Télécharger le projet</a>
</p>
